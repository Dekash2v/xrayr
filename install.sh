...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/Dekash2v/xrayr/main/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/Dekash2v/xrayr/main/xrayx.sh
